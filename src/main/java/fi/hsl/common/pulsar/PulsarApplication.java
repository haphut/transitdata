...
public class PulsarApplication implements AutoCloseable {
    ...
    private PulsarClient createPulsarClient(String pulsarHost, int pulsarPort) throws Exception {
    ...
    private Producer<byte[]> createProducer(PulsarClient client, Config config) throws PulsarClientException {
    ...
    private Consumer<byte[]> createConsumer(PulsarClient client, Config config) throws PulsarClientException {
    ...
    private PulsarAdmin createAdmin(String adminHost, int adminPort) throws PulsarClientException {
    ...
    private Jedis createRedisClient(String redisHost, int port, int connTimeOutSecs) {
    ...
    private PulsarApplicationContext createContext(Config config, PulsarClient client,
