...
public class TransitdataProperties {
    ...
    public static final String KEY_LAST_CACHE_UPDATE_TIMESTAMP = "config.cache-update-ts";
    ...
    public enum ProtobufSchema {
        ...
        public String toString() {
            switch (this) {
                case PubtransRoiArrival:
                    return "pubtrans-roi-arrival";
                case PubtransRoiDeparture:
                    return "pubtrans-roi-departure";
                case GTFS_TripUpdate:
                    return "gtfs-trip-update";
                case GTFS_ServiceAlert:
                    return "gtfs-service-alert";
                case GTFS_VehiclePosition:
                    return "gtfs-vehicle-position";
                case InternalMessagesTripCancellation:
                    return "internal-messages-trip-cancellation";
                case InternalMessagesStopEstimate:
                    return "internal-messages-stop-estimate";
                case MetroAtsEstimate:
                    return "metro-ats-estimate";
                case MqttRawMessage:
                    return "mqtt-raw";
                case HfpData:
                    return "hfp-data";
                case TransitdataServiceAlert:
                    return "transitdata-service-alert";
                default:
                    throw new IllegalArgumentException();
            }
        }
