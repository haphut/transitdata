 ...
 * These are basically application-specific stuff but bundling these to fi.hsl.common-library
...
public class PubtransFactory {
    ...
    private static final long PUBTRANS_SKIPPED_STATE = 3L;
    ...
    private static InternalMessages.TripInfo createTripInfo(PubtransTableProtos.DOITripInfo doiInfo) throws Exception {
